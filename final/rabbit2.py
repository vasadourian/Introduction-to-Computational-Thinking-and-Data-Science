...
coeff = pylab.polyfit(range(len(foxlist)), foxlist, 2)

pylab.plot(pylab.polyval(coeff, range(len(foxlist))),'g',label='fox curve')

coeff2 = pylab.polyfit(range(len(rablist)), rablist, 2)

pylab.plot(pylab.polyval(coeff2, range(len(rablist))),'g',label='rabbit curve')
